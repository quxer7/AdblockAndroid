...
import com.quxer7.adfilter.script.raws.IMInject
...
internal object ScriptInjection {
    ...
    fun loadInjectJS(): String {
        val injectJS = mezzanine<IMInject>().produce()
        return parse(injectJS)
    }
