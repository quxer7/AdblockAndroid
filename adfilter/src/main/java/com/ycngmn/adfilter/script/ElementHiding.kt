...
internal class ElementHiding(
    ...
    private val eleHidingJS: String by lazy {
        loadAsset("extended-css.min.js") +
                ScriptInjection.parseScript(context, this, loadAsset("element_hiding.js"), wrapper = true)
    }

    private val elemhideBlockedJs: String by lazy {
        ScriptInjection.parseScript(context, this, loadAsset("elemhide_blocked.js"))
    }
    ...
    private fun loadAsset(filename: String): String =
        try {
            ...
            Log.e("ElementHiding", "Failed to load asset $filename", e)
            ""
        }
